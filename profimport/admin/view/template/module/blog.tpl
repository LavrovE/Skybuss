...
function isVisible(){
    $('#iframeelement').each(function(){
        if($(this).is(':visible')){
			...
			$('#iframeelement').html('<iframe src="http://anonym.to/?http://opencartadmin.com/doc/index.<?php echo substr(strtolower($config->get('config_admin_language')), 0,2); ?>.html" style="width: 100%; height: 100%; min-height: '+ if_height +'px; border-top: 1px solid #AAA; border-bottom: 1px solid #AAA;"></iframe>');
